// tests/shared/config/enhanced.config.fixed.test.ts
...
describe('Enhanced Configuration System (Fixed)', () => {
  ...
  describe('Storage Configuration', () => {
    it('should load storage configuration with defaults', () => {
      ...
      expect(config.STORAGE_FALLBACK_ENABLED).to.be.false; // test environment default
  ...
  describe('CLI Configuration', () => {
    it('should load CLI configuration with defaults', () => {
      ...
      expect(config.CLI_PROGRESS_ENABLED).to.be.false; // test environment default
      expect(config.CLI_VERBOSE_LOGGING).to.be.false; // test environment default
    });
